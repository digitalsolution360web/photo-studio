          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              {packages.map((pkg, index) => (
                <div
                  key={index}
                  className={`relative p-8 md:p-7 rounded-[3.5rem] flex flex-col h-full border border-slate-100 transition-all duration-700 hover:-translate-y-4 hover:shadow-2xl ${pkg.color}`}
                >
                  ...
                  <Link
                    href="/contact"
                    className={`block w-full text-center py-5 rounded-full font-bold text-lg transition-all active:scale-95 shadow-xl ${index === 2
